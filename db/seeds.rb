...
type19 = PrdType.create(name: "Sheets & Pillowcases", prd_sub_category_id:subct2.id)
type20 = PrdType.create(name: "Duvet Covers & Sets",prd_sub_category_id:subct2.id)
type21 = PrdType.create(name: "Bed Skirts", prd_sub_category_id:subct2.id)
type22 = PrdType.create(name: "Other Bedding", prd_sub_category_id:subct2.id)
type23 = PrdType.create(name: "Mattress Pads & Feather Beds", prd_sub_category_id:subct2.id)
type24 = PrdType.create(name: "Comforters & Sets", prd_sub_category_id:subct2.id)
type25 = PrdType.create(name: "Quilts, Bedspreads & Coverlets", prd_sub_category_id:subct2.id)
type26 = PrdType.create(name: "Blankets & Throws", prd_sub_category_id:subct2.id)
type27 = PrdType.create(name: "Bed Pillows", prd_sub_category_id:subct2.id)
type28 = PrdType.create(name: "Pillow Shams", prd_sub_category_id:subct2.id)
type29 = PrdType.create(name: "Canopies & Netting", prd_sub_category_id:subct2.id)
type30 = PrdType.create(name: "Decorative Bed Pillows", prd_sub_category_id:subct2.id)
...
var_type5 = PrdTypeVariation.create(prd_type_id:type1.id,prd_variation_item_id:item_variation1.id, prd_variation_id:variation6.id )
var_type6 = PrdTypeVariation.create(prd_type_id:type1.id,prd_variation_item_id:item_variation1.id, prd_variation_id:variation7.id )
var_type7 = PrdTypeVariation.create(prd_type_id:type4.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation1.id )
var_type8 = PrdTypeVariation.create(prd_type_id:type4.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation2.id )
var_type9 = PrdTypeVariation.create(prd_type_id:type4.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation3.id )
var_type10 = PrdTypeVariation.create(prd_type_id:type4.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation4.id )
var_type11 = PrdTypeVariation.create(prd_type_id:type4.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation5.id )
var_type12 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation5.id )
var_type13 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation1.id )
var_type14 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation2.id )
var_type15 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation3.id )
var_type16 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation2.id, prd_variation_id:variation4.id )
var_type17 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation1.id, prd_variation_id:variation6.id )
var_type18 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation1.id, prd_variation_id:variation7.id )
var_type19 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation1.id, prd_variation_id:variation8.id )
var_type20 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation1.id, prd_variation_id:variation9.id )
var_type21 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation4.id, prd_variation_id:variation15.id )
var_type22 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation4.id, prd_variation_id:variation16.id )
var_type23 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation4.id, prd_variation_id:variation17.id )
var_type24 = PrdTypeVariation.create(prd_type_id:type19.id,prd_variation_item_id:item_variation4.id, prd_variation_id:variation18.id )
